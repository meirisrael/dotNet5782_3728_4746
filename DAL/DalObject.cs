...
namespace DalObject
{
	public class DalObject : IDAL.IDal
	{
		...
		/// </summary>
		public IDAL.DO.BaseStation DisplayBaseStation()
        {
		...
		/// </summary>
		public IDAL.DO.Drone DisplayDrone()
		{
			Console.WriteLine("Enter Id:");
			int a, i = 0;
			int.TryParse(Console.ReadLine(), out a);
		...
		/// </summary>
		public IDAL.DO.Customer DisplayCustomer()
		{
			Console.WriteLine("Enter Id:");
			int a, i = 0;
			int.TryParse(Console.ReadLine(), out a);
		...
		/// </summary>
		public IDAL.DO.Parcel DisplayParcel()
		{
			Console.WriteLine("Enter Id:");
			int a, i = 0;
			int.TryParse(Console.ReadLine(), out a);
